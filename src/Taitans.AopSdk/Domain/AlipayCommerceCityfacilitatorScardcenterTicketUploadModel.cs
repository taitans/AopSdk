...
{
    /// <summary>
    /// AlipayCommerceCityfacilitatorScardcenterTicketUploadModel Data Structure.
    /// </summary>
    [Serializable]
    public class AlipayCommerceCityfacilitatorScardcenterTicketUploadModel : AopObject
    {
        /// <summary>
        /// 渠道商提供的其它信息
        /// </summary>
